...
HELPDIR="/nix/store/am0wjwz25yw7q8llxhlbkh44jsan1a9m-zsh-5.9/share/zsh/$ZSH_VERSION/help"
...
source /nix/store/mz7450jh16yd16zv1z54927wbiw27nb4-zsh-autosuggestions-0.7.0/share/zsh-autosuggestions/zsh-autosuggestions.zsh
...
if [[ $TERM != "dumb" ]]; then
  eval "$(/home/hayato/.nix-profile/bin/starship init zsh)"
fi

source /nix/store/pbhdw2fkxrvqdqffz9kddjxq6dcb2dfa-nix-index-0.1.7/etc/profile.d/command-not-found.sh
