...
with lib;
let
 cfg = config.mod.hyprland;
in
{
  options.mod.hyprland = {
    enable = mkEnableOption "Enable hyprland config and my custom values";
  };
  ...
  config = mkIf cfg.enable {
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        bindel = [
            "$mainMod, Page_Up, exec, wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+"
        ...
        monitor = [
          ...
          "HDMI-A-3,highres,0x0,1"
          "HDMI-A-1,highres,-1080x-1080,1,transform,3"
